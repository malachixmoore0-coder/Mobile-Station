...
export const RECIPES: Recipe[] = [
  {
    ...
    ingredients: [
      ...
      { item: 'Rolled oats', amount: '1/2 cup (40 g dry)', alt: 'Cream of rice' },
    ...
    assembly: {
      ...
      steps: [
        ...
        'Weigh 40 g dry oats straight into the blender.',
  ...
  },
  {
    ...
    ingredients: [
      ...
      { item: 'White jasmine rice', amount: '2 cups dry per batch' },
    ...
    batchPrep: {
      ...
      steps: [
        'Rice cooker: 2 cups dry jasmine rice + 2 cups water, press Cook.',
    ...
    assembly: {
      ...
      steps: [
        ...
        'Weigh 7 oz (200 g) cooked jasmine rice.',
  ...
  },
  {
    ...
    ingredients: [
      ...
      { item: 'Medium sweet potatoes', amount: '4 per batch', alt: 'Extra jasmine rice' },
    ...
    assembly: {
      ...
      steps: [
        'Place the container on the scale and tare to zero.',
        'Weigh 1 cooked sweet potato (~7-8 oz / 200 g), or 7 oz cooked rice.',
  ...
  },
  {
    ...
    assembly: {
      ...
      steps: [
        ...
        'Toss the greens in 1 tbsp olive oil, salt and lemon juice.',
...
export const PREP_SESSION: Steps[] = [
  {
    ...
    steps: [
      '2 cups dry jasmine rice + 2 cups water in the rice cooker.',
      '2 lbs 93/7 ground beef browned with garlic powder, salt and pepper; drain.',
      '4 cups frozen greens, microwaved 3 minutes.',
      'Portion into 4 containers: 200 g rice, 170 g beef, 1 cup greens.',
    ],
  },
  {
    ...
    steps: [
      ...
      '4 medium sweet potatoes, forked, on the same oven rack — 400°F for 45 minutes.',
